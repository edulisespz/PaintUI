...
BOOL bSetupPixelFormat(HDC hdc)
{
	...
	{
		MessageBox(NULL, (LPCWSTR)"ChoosePixelFormat failed", (LPCWSTR)"Error", MB_OK);
		return FALSE;
	}

	if (SetPixelFormat(hdc, pixelformat, ppfd) == FALSE)
	{
		MessageBox(NULL, (LPCWSTR)"SetPixelFormat failed", (LPCWSTR)"Error", MB_OK);
		return FALSE;
	}
